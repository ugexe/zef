...
dependency it otherwise causes] if were to be renamed back to Build.pm). Note the generated Build.pm.zef file will
be deleted after it is used; This is meant to provoke an actual dependency free hook interface defined by rakudo core.
