...
[C<identities>] can be in the form of a file path (starting with B<.> or B</>), URNs, or full identities:
    ...
    # URN + IDENTITY
    `zef install "CSV::Parser:ver<0.1.2>" github:ugexe:Net--HTTP:0.1`

    # PATH
    `zef install /some/path`

In the name portion of the B<URN> style a double I<--> indicates a I<::>. This is because modules can have I<->
