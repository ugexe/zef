...
Take I<*%args> filters. That is, any I<--[field]="term"> passed will search for "term" in it's META [field].

Add a I<*> to any filter to have the filter apply a C<.starts-with()> filter using the string to the left of the I<*>.

Note: I<*> behaves slightly differently for versions
