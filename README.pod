...
B<Example>: (note parallelized output format will be improved)
    ...
    $ perl6 -Ilib bin/zef -v install CSV::Parser P6TCI
    ...
    01_multiline_csv.t  # perl6 --ll-exception -I/tmp/CSV--Parser/blib -I/tmp/CSV--Parser/lib -I/tmp/P6TCI/blib -I/tmp/P6TCI/lib t/01_multiline_csv.t
    01_multiline_csv.t  # 1..1
    01_multiline_csv.t  # ok 1 -
    02_escaped_csv.t    # perl6 --ll-exception -I/tmp/CSV--Parser/blib -I/tmp/CSV--Parser/lib -I/tmp/P6TCI/blib -I/tmp/P6TCI/lib t/02_escaped_csv.t
    02_escaped_csv.t    # 1..1
    02_escaped_csv.t    # ok 1 -
    03_delimiters_csv.t # perl6 --ll-exception -I/tmp/CSV--Parser/blib -I/tmp/CSV--Parser/lib -I/tmp/P6TCI/blib -I/tmp/P6TCI/lib t/03_delimiters_csv.t
    03_delimiters_csv.t # 1..1
    03_delimiters_csv.t # ok 1 -
    04_binary_csv.t     # perl6 --ll-exception -I/tmp/CSV--Parser/blib -I/tmp/CSV--Parser/lib -I/tmp/P6TCI/blib -I/tmp/P6TCI/lib t/04_binary_csv.t
    04_binary_csv.t     # 1..1
    04_binary_csv.t     # ok 1 -
    00-load.t           # perl6 --ll-exception -I/tmp/CSV--Parser/blib -I/tmp/CSV--Parser/lib -I/tmp/P6TCI/blib -I/tmp/P6TCI/lib t/00-load.t
...
B<Example>:
    ...
    $ perl6 -Ilib bin/zef -v search HTTP*
...
B<Example>:
    ...
    $ perl6 -Ilib bin/zef -v info HTTP::UserAgent
    ===> Querying Server [done]
    ===> Filtering Results [done]
    ===> Found 1 results
    [HTTP::UserAgent]
...
The base project class containing path and META information.
    ...
    my $dist = Zef::Distribution.new(:path($*CWD) :includes<blib/lib lib>);
...
=head2 Zef::Roles::Processing
    ...
    role Zef::Roles::Processing[Bool :$async]
        ...
        method failures                  # helper functin to show name of processes where exitcode > 0
