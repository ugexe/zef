...
subtest {
    ...
    is_deeply $decoder.b64decode('AA=='), Buf.new(0), 'decode Test on NULL/0 byte';
    is_deeply $decoder.b64decode('AQ=='), Buf.new(1), 'decode Test on byte value 1';
    is_deeply $decoder.b64decode('/w=='), Buf.new(255), 'decode Test on byte value 255';
}, 'Decode';
